...
---@overload fun(fx:number, fy:number):void
...
---@overload fun(ix:number, iy:number):void
...
---@param type BodyType? # The type of the body. (Defaults to 'static'.)
---@return Body
...
---@param radius number # The radius of the circle.
---@return CircleShape
---@overload fun(radius:number):CircleShape
...
---@overload fun(body1:Body, body2:Body, x:number, y:number, collideConnected:boolean?):FrictionJoint
...
---@param collideConnected boolean? # Specifies whether the two bodies should collide with each other. (Defaults to false.)
---@return MotorJoint
---@overload fun(body1:Body, body2:Body, correctionFactor:number?):MotorJoint
...
---@overload fun(body1:Body, body2:Body, x:number, y:number, ax:number, ay:number, collideConnected:boolean?):PrismaticJoint
...
---@return PolygonShape
---@overload fun(width:number, height:number):PolygonShape
...
---@overload fun(body1:Body, body2:Body, x:number, y:number, collideConnected:boolean?):RevoluteJoint
...
---@overload fun(body1:Body, body2:Body, x:number, y:number, collideConnected:boolean?):WeldJoint
...
---@param collideConnected boolean? # Specifies whether the two bodies should collide with each other. (Defaults to false.)
---@return WheelJoint
---@overload fun(body1:Body, body2:Body, x:number, y:number, ax:number, ay:number, collideConnected:boolean?):WheelJoint
