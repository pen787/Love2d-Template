...
---@param step VertexAttributeStep? # Whether the attribute will be per-vertex or per-instance when the mesh is drawn. (Defaults to 'pervertex'.)
...
---@overload fun(name:string, mesh:Mesh):void
...
---@overload fun(index:number, attributecomponent:number, ...:number):void
...
---@overload fun(name:string, number:number, ...:number):void
...
---@return number
---@overload fun(x:number, y:number, r:number?, sx:number?, sy:number?, ox:number?, oy:number?, kx:number?, ky:number?):number
...
---@return number
---@overload fun(layerindex:number, x:number?, y:number?, r:number?, sx:number?, sy:number?, ox:number?, oy:number?, kx:number?, ky:number?):number
...
---@param kx number? # Shear factor (x-axis). (Defaults to 0.)
---@param ky number? # Shear factor (y-axis). (Defaults to 0.)
---@overload fun(spriteindex:number, x:number, y:number, r:number?, sx:number?, sy:number?, ox:number?, oy:number?, kx:number?, ky:number?):void
...
---@param kx number? # Shearing factor (x-axis). (Defaults to 0.)
---@param ky number? # Shearing factor (y-axis). (Defaults to 0.)
---@overload fun(spriteindex:number, layerindex:number, x:number?, y:number?, r:number?, sx:number?, sy:number?, ox:number?, oy:number?, kx:number?, ky:number?):void
...
---@param mag FilterMode? # Filter mode to use when magnifying the texture (rendering it at a larger size on-screen than its size in pixels). (Defaults to min.)
...
---@param vert WrapMode? # Vertical wrapping mode of the texture. (Defaults to horiz.)
---@param depth WrapMode? # Wrapping mode for the z-axis of a Volume texture. (Defaults to horiz.)
...
---@param source Source? # The audio Source used for audio playback, or nil to disable audio synchronization. (Defaults to nil.)
...
---@overload fun(drawmode:DrawMode, x:number, y:number, radius:number, angle1:number, angle2:number, segments:number?):void
...
---@overload fun(mode:DrawMode, x:number, y:number, radius:number):void
...
---@param kx number? # Shearing factor (x-axis). (Defaults to 0.)
---@param ky number? # Shearing factor (y-axis). (Defaults to 0.)
---@overload fun(drawable:Drawable, x:number?, y:number?, r:number?, sx:number?, sy:number?, ox:number?, oy:number?, kx:number?, ky:number?):void
...
---@param kx number? # Shearing factor (x-axis). (Defaults to 0.)
---@param ky number? # Shearing factor (y-axis). (Defaults to 0.)
---@overload fun(texture:Texture, layerindex:number, x:number?, y:number?, r:number?, sx:number?, sy:number?, ox:number?, oy:number?, kx:number?, ky:number?):void
...
---@overload fun(mode:DrawMode, x:number, y:number, radiusx:number, radiusy:number):void
...
---@param settings table? # Optional table of settings to configure the array image, containing the following fields: (Defaults to nil.)
---@return Image
...
---@param settings table? # A table containing the given fields: (Defaults to nil.)
---@return Canvas
...
---@param settings table? # Optional table of settings to configure the cubemap image, containing the following fields: (Defaults to nil.)
---@return Image
...
---@param hinting HintingMode? # True Type hinting mode. (Defaults to 'normal'.)
...
---@overload fun(filename:string):Font
...
---@param settings table? # A table containing the following fields: (Defaults to nil.)
---@return Image
...
---@overload fun(filename:string, glyphs:string):Font
...
---@param vertices table # The table filled with vertex information tables for each vertex, in the form of {vertex, ...} where each vertex is a table in the form of {attributecomponent, ...}.
---@param mode MeshDrawMode? # How the vertices are used when drawing. The default mode 'fan' is sufficient for simple convex polygons. (Defaults to 'fan'.)
---@param usage SpriteBatchUsage? # The expected usage of the Mesh. The specified usage mode affects the Mesh's memory usage and performance. (Defaults to 'dynamic'.)
---@return Mesh
---@overload fun(vertexformat:table, vertexcount:number, mode:MeshDrawMode?, usage:SpriteBatchUsage?):Mesh
---@overload fun(vertices:table, mode:MeshDrawMode?, usage:SpriteBatchUsage?):Mesh
...
---@return Shader
---@overload fun(code:string):Shader
...
---@param usage SpriteBatchUsage? # The expected usage of the SpriteBatch. The specified usage mode affects the SpriteBatch's memory usage and performance. (Defaults to 'dynamic'.)
---@return SpriteBatch
---@overload fun(image:Image, maxsprites:number?, usage:SpriteBatchUsage?):SpriteBatch
---@overload fun(image:Image, maxsprites:number?):SpriteBatch
...
---@overload fun(filename:string):Video
...
---@param settings table? # Optional table of settings to configure the volume image, containing the following fields: (Defaults to nil.)
---@return Image
...
---@param align AlignMode? # The alignment. (Defaults to 'left'.)
---@param r number? # Orientation (radians). (Defaults to 0.)
---@param sx number? # Scale factor (x-axis). (Defaults to 1.)
---@param sy number? # Scale factor (y-axis). (Defaults to sx.)
---@param ox number? # Origin offset (x-axis). (Defaults to 0.)
...
---@overload fun(text:string, x:number, y:number, limit:number, align:AlignMode?, r:number?, sx:number?, sy:number?, ox:number?, oy:number?, kx:number?, ky:number?):void
...
---@overload fun(mode:DrawMode, x:number, y:number, width:number, height:number):void
...
---@param alphamode BlendAlphaMode? # What to do with the alpha of drawn objects when blending. (Defaults to 'alphamultiply'.)
---@overload fun(mode:BlendMode):void
...
---@overload fun(canvas:Canvas, mipmap:number?):void
...
---@param mag FilterMode? # Filter mode used when scaling the image up. (Defaults to min.)
---@param anisotropy number? # Maximum amount of Anisotropic Filtering used. (Defaults to 1.)
...
---@param action StencilAction? # How to modify any stencil values of pixels that are touched by what's drawn in the stencil function. (Defaults to 'replace'.)
