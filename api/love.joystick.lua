...
---@return boolean
---@overload fun(left:number, right:number):boolean
...
---@param hatdir JoystickHat? # The direction of the hat, if the virtual gamepad button will be bound to a hat. nil otherwise. (Defaults to nil.)
---@return boolean
