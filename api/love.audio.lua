...
---@param unit TimeUnit? # The time unit for the return value. (Defaults to 'seconds'.)
---@return number
...
---@param unit TimeUnit? # The unit of the position value. (Defaults to 'seconds'.)
...
---@param unit TimeUnit? # The type of unit for the return value. (Defaults to 'seconds'.)
---@return number
